...
public class SourceLinkCategoryProfile : Profile
{
    public SourceLinkCategoryProfile()
    {
        ...
        CreateMap<SourceLinkCategory, ImageDto>()
            .ForMember(dest => dest.MimeType, opt => opt.MapFrom(src => src.Image != null ? src.Image.MimeType : ""))
            .ForMember(dest => dest.BlobName, opt => opt.MapFrom(src => src.Image != null ? src.Image.BlobName : ""));
